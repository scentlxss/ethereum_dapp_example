...
mocha_1.describe("JSONRPCServerAndClient", function () {
    ...
    mocha_1.beforeEach(function () {
        ...
        serverAndClient1.addMethodAdvanced("echo1-2", function (jsonRPCRequest, _a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    return [2 /*return*/, ({
                            ...
                            result: userID + " said " + jsonRPCRequest.params.message,
                        })];
                });
            });
        });
    ...
    mocha_1.describe("requesting from server 1", function () {
        var result;
        ...
        mocha_1.it("should request to server 2", function () {
            chai_1.expect(result).to.equal("foo");
        });
    });
    mocha_1.describe("requesting from server 2", function () {
        var result;
        mocha_1.beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        mocha_1.it("should request to server 1", function () {
            chai_1.expect(result).to.equal("bar");
        });
    });
    mocha_1.describe("requesting from server 1 using advanced method", function () {
        var response;
        mocha_1.beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
        ...
        mocha_1.it("should request to server 1", function () {
            chai_1.expect(response.result).to.equal("baz said test");
        });
    });
    mocha_1.describe("receiving invalid JSON-RPC message", function () {
        var promise;
        mocha_1.beforeEach(function () {
    ...
    mocha_1.describe("having a pending request", function () {
        var promise;
        var resolve;
        mocha_1.beforeEach(function () {
        ...
        mocha_1.describe("rejecting all pending requests", function () {
            var message;
            mocha_1.beforeEach(function () {
            ...
            mocha_1.it("should reject the pending request", function () {
                return promise.then(function () { return Promise.reject(new Error("Expected to fail")); }, function (error) { return chai_1.expect(error.message).to.equal(message); });
            });
        });
    });
    mocha_1.describe("requesting with timeout", function () {
        var fakeTimers;
        var delay;
        var resolve;
        var promise;
        ...
        mocha_1.describe("timing out", function () {
            mocha_1.beforeEach(function () {
        ...
        mocha_1.describe("not timing out", function () {
            mocha_1.beforeEach(function () {
                resolve();
            });
            mocha_1.it("should succeed", function () {
                return promise;
            });
        });
    });
