        ...
        mocha_1.describe("using " + apiModel + " API", function () {
            ...
            mocha_1.describe("requesting with timeout", function () {
                ...
                mocha_1.describe("not timing out", function () {
                    ...
                    mocha_1.it("should respond", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var actual;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    actual = _a.sent();
                                    chai_1.expect(actual).to.equal(result);
                                    return [2 /*return*/];
                            }
                        });
                    }); });
            ...
            mocha_1.describe("requesting advanced with timeout", function () {
                var delay;
                var fakeTimers;
                var promise;
                mocha_1.beforeEach(function () {
                    ...
                    mocha_1.it("should respond", function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    actual = _a.sent();
                                    chai_1.expect(actual).to.deep.equal(result);
                                    return [2 /*return*/];
                            }
                        });
                    }); });
            ...
            mocha_1.describe("requesting with custom timeout error response", function () {
                var delay;
                var fakeTimers;
                var errorCode;
                var errorMessage;
                ...
                mocha_1.beforeEach(function () {
                    ...
                    promise = client
                        ...
                        return _1.createJSONRPCErrorResponse(id, errorCode, errorMessage, errorData);
                    })
                        .requestAdvanced({
                        jsonrpc: _1.JSONRPC,
                        id: ++id,
                ...
                mocha_1.describe("timing out", function () {
                    ...
                    mocha_1.it("should reject with the custom error", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var actual, expected;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, promise];
                                case 1:
                                    ...
                                    chai_1.expect(actual.error).to.deep.equal(expected);
                                    return [2 /*return*/];
                            }
                        });
                    }); });
