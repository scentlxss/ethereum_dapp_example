...
mocha_1.describe("JSONRPCServer", function () {
    ...
    mocha_1.describe("having a custom mapErrorToJSONRPCErrorResponse method", function () {
        ...
        mocha_1.beforeEach(function () {
            ...
            server.mapErrorToJSONRPCErrorResponse = function (id, error) {
                return _1.createJSONRPCErrorResponse(id, error.code, "" + errorMessagePrefix + error.message, errorData);
            };
        });
        mocha_1.describe("rejecting", function () {
            var errorCode;
            ...
            mocha_1.it("should respond a custom error code", function () {
                chai_1.expect(response.error.code).to.equal(errorCode);
            });
            mocha_1.it("should respond a custom error message", function () {
                chai_1.expect(response.error.message).to.equal("" + errorMessagePrefix + errorMessage);
            });
            mocha_1.it("should respond a custom error data", function () {
                chai_1.expect(response.error.data).to.deep.equal(errorData);
            });
        });
    });
});
